"""Locomotion randomization presets for zeroth_robot."""

from holosoma.config_types.randomization import RandomizationManagerCfg, RandomizationTermCfg

zeroth_robot_randomization = RandomizationManagerCfg(
    setup_terms={
        ...
        "mass_randomizer": RandomizationTermCfg(
            ...
            params={
                ...
                "added_mass_range": [-0.2, 1.0],  # smaller range for a lighter robot
            },
        ),
...
__all__ = ["zeroth_robot_randomization"]
