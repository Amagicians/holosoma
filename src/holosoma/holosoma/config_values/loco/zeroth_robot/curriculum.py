"""Locomotion curriculum presets for zeroth_robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

zeroth_robot_curriculum = CurriculumManagerCfg(
    params={
...
zeroth_robot_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["zeroth_robot_curriculum", "zeroth_robot_curriculum_fast_sac"]
